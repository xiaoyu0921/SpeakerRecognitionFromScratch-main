...
from data_prepare import specaug, feature_extraction
import train
import evaluation
import myconfig
...
class TestNeuralNet(unittest.TestCase):
    ...
    def test_get_triplet_loss1(self):
        ...
        loss = train.get_triplet_loss(anchor, pos, neg)
    ...
    def test_get_triplet_loss_from_batch_output1(self):
        ...
        loss = train.get_triplet_loss_from_batch_output(
    ...
    def test_train_unilstm_network(self):
        ...
        losses = train.train_network(self.spk_to_utts, num_steps=2)
...
class TestEvaluation(unittest.TestCase):
    def setUp(self):
        ...
        myconfig.FRAME_AGGREGATION_MEAN = False
        myconfig.USE_TRANSFORMER = False
        self.encoder = train.get_speaker_encoder().to(myconfig.DEVICE)
        self.spk_to_utts = dataset.get_librispeech_spk_to_utts(
            myconfig.TEST_DATA_DIR)
